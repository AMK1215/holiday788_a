...
class Jili extends Command
{
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/jili_new_list.json');
        $outputFilePath = base_path('app/Console/Commands/data/JiliNewModify.json');
