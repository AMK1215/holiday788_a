...
class FastSpin extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:fastspin';
    ...
    {
        $inputFilePath = base_path('app/Console/Commands/json_data/fastSpin.json');
        $outputFilePath = base_path('app/Console/Commands/data/FastSpinModify.json');
